...
print_results("fruits_DQN_AAF")
print_results("fruits_DQN_baselines")
print_results("fruits_DQN_transfer")
print_results("fruits_DQN_freeze_transfer")
print_results("fruits_DQN_side_transfer")
