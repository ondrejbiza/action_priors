...
from ....run.offline.fruits_seq.RunAAF import RunAAFSeq
from ....constants import Constants
from .... import constants
from ....utils.logger import Logger
from .... import paths

ex = Experiment("fruits_seq_AAF")
...
def main(load_path, encoder_learning_rate, encoder_weight_decay, validation_fraction, batch_size, discount,
         plot_dataset_examples, num_training_steps, device, model_save_path, model_load_path, plot_results,
         plot_prediction_examples, ignore_list):
    ...
    runner_config = {
        ...
        Constants.INPUT_SIZE: ((5, 5, 5), (5, 5)),
    ...
    runner = RunAAFSeq(runner_config, model_config, logger)
    runner.train_model()
    runner.evaluate()
