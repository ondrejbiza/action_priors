...
from .... import paths
from ....run.offline.fruits_seq.RunActorMimicV2 import RunActorMimicV2Seq
from ....utils.logger import Logger
from ....utils import sacred_utils

ex = Experiment("fruits_seq_actor_mimic_v2")
...
def main(teacher_load_paths, goals, num_fruits, tau, learning_rate, weight_decay, epsilon, buffer_size,
    ...
    runner = RunActorMimicV2Seq(runner_config, student_config, teacher_config, logger)
    runner.train_model()
